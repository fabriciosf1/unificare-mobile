...
import { updateFamilyExam } from '../services/family.service';
...
export default function FamilyEditExamScreen({ exam, onBack, onSaved }: { exam: ExamResult; onBack: () => void; onSaved: () => void }) {
  ...
  async function handleSubmit() {
    ...
    setSaving(true);
    try {
      await updateFamilyExam(exam.uuid, { exam_type: examType, exam_date: date, observations: observations || null });
      onSaved();
    } catch {
